...
class  CustomMidiKeyboardComponent : public Component,
...
public:
	...
	*/
	...
	/** Gets the base note above which key-press-triggered notes are played.
...
private:
	//==============================================================================
	friend class CustomMidiKeyboardUpDownButton;
...
#endif   //CUSTOMMIDIKEYBOARDCOMPONENT_H_INCLUDED
